...
$out = "san_raf_mag_map_upward20.eps";
...
system "gmt grdfft surf.grd -Gfiltered.grd -C25 -V";
system "gmt makecpt -C$color_file -T$min_value/$max_value/$cint -V > map.cpt";
system "gmt grdimage filtered.grd -Jx1:12000 -Cmap.cpt -Ba400f50:’’:/a200f50:’’:/WSne -K -V > $out";
