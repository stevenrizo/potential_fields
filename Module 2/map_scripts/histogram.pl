...
`gmt pshistogram --ANNOT_FONT_SIZE_PRIMARY=12 --FONT_LABEL=14 --FONT_LABEL=1 $in -X1i -Y1i -R$min/$max/0/$count -JX4i -W10 -Lthinner -i$col -B$xannot$bin_width:'$unit':/$yannot:'Frequency':/WS -G200 -V -P > $out`;
